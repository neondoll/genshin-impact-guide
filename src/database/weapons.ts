...
class _Weapon implements Weapon {
  readonly key: Weapon["key"];
  readonly name: Weapon["name"];
  readonly rarity: Weapon["rarity"];
  readonly source: Weapon["source"];
  readonly type_key: Weapon["type_key"];
  ...
  constructor(
    ...
    secondaryStats: Omit<Weapon["secondary_stats"], "key">,
    imageName: string,
  ) {
    ...
    this.image_src = publicImageSrc(`${_Weapon.PATH}/${imageName}`);
  }
}
...
export default {
  [WeaponKeys.AThousandBlazingSuns]: new _Weapon(
  ...
  [WeaponKeys.AThousandFloatingDreams]: new _Weapon(
