...
export default {
  ...
  [CharacterRoleUidEnum.OffField]: {
    uid: CharacterRoleUidEnum.OffField,
    name: "Вне поля",
  ...
  [CharacterRoleUidEnum.OnField]: {
    uid: CharacterRoleUidEnum.OnField,
    name: "На поле",
  ...
  [CharacterRoleUidEnum.Support]: {
    uid: CharacterRoleUidEnum.Support,
    name: "Поддержка",
  ...
  [CharacterRoleUidEnum.Survivability]: {
    uid: CharacterRoleUidEnum.Survivability,
    name: "Выживание",
...
} as Record<CharacterRoleUid, CharacterRole>;
