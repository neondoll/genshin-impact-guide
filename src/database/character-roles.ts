...
export default {
  ...
  [CharacterRoleKeys.OffField]: {
    key: CharacterRoleKeys.OffField,
    name: "Вне поля",
  ...
  [CharacterRoleKeys.Survivability]: {
    key: CharacterRoleKeys.Survivability,
    name: "Выживание",
...
} as Record<CharacterRoleKey, CharacterRole>;
