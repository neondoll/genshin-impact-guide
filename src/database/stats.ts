...
export default {
  ...
  [StAtkeys.DefPercentage]: { key: StAtkeys.DefPercentage, name: "Процент от защиты", abbr: "Защита %" },
  ...
  [StAtkeys.HpPercentage]: { key: StAtkeys.HpPercentage, name: "Процент от HP", abbr: "HP %" },
