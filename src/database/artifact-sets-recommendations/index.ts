...
export default {
  ...
  [ArtifactSetUidEnum.GoldenTroupe]: (await import("./golden_troupe-recommendations")).default,
  ...
  [ArtifactSetUidEnum.MarechausseeHunter]: (await import("./marechaussee_hunter-recommendations")).default,
  [ArtifactSetUidEnum.NighttimeWhispersInTheEchoingWoods]: (await import("./nighttime_whispers_in_the_echoing_woods-recommendations")).default,
  ...
  [ArtifactSetUidEnum.SongOfDaysPast]: (await import("./song_of_days_past-recommendations")).default,
  ...
  [ArtifactSetUidEnum.VourukashasGlow]: (await import("./vourukashas_glow-recommendations")).default,
