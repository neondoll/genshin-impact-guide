...
export default {
  ...
  [ArtifactSetUidEnum.GildedDreams]: {
    ...
    qualities: [4, 5],
    where_to_find: [
      "Подземелье «Шпиль одинокого просветления». Благословение: Семь чувств.",
      "Мистическое подношение (Алхимия)",
    ],
    item_bonuses: {
  ...
  [ArtifactSetUidEnum.FlowerOfParadiseLost]: {
    ...
    qualities: [4, 5],
    where_to_find: [
      "Подземелье «Город золота». Благословение: Цитадель в пустыне.",
      "Мистическое подношение (Алхимия)",
    ],
    item_bonuses: {
      2: "Увеличивает мастерство стихий на 80 ед.",
  ...
  [ArtifactSetUidEnum.NoblesseOblige]: {
    ...
    qualities: [4, 5],
    where_to_find: [
      "Подземелье «Чистая вода и горная пещера». Благословение: Каменная темница",
      "Мистическое подношение (Алхимия)",
    ],
    item_bonuses: {
