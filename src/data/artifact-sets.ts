...
export default {
  ...
  [ArtifactSetIds.NightOfTheSkysUnveiling]: ArtifactSetClass.init([
    ArtifactSetIds.NightOfTheSkysUnveiling,
    "Ночь открытия неба",
    [4, 5],
    ...
    {
      [ArtifactSlotIds.Flower]: "Цветок жажды познания",
      [ArtifactSlotIds.Plume]: "Перо несмываемого греха",
      [ArtifactSlotIds.Sands]: "Звон откровения",
      [ArtifactSlotIds.Goblet]: "Сосуд изобилия",
      [ArtifactSlotIds.Circlet]: "Корона вечности",
    },
  ]),
