...
export default new ArtifactSetRecommendations(ARTIFACT_SETS.THUNDERING_FURY)
  .setCharacters([
  ...
  .setPreferredStats({
    ...
    [ARTIFACT_SLOTS.GOBLET]: [...StatsElementDamageBonus, STATS.ATK_PERCENTAGE, STATS.ELEMENTAL_MASTERY],
