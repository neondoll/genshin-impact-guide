...
export default {
  [WeaponIds.AThousandBlazingSuns]: Class.init([
    ...
    STATS.CRIT_RATE,
    { min_value: formatPercent(0.024), max_value: formatPercent(0.110) },
  ...
  [WeaponIds.Absolution]: Class.init([
    ...
    STATS.CRIT_DMG,
    { min_value: formatPercent(0.096), max_value: formatPercent(0.441) },
    ClassPassiveAbility.init([
      "Пакт смерти",
  ...
  [WeaponIds.Akuoumaru]: Class.init([
    ...
    { min_value: formatPercent(0.090), max_value: formatPercent(0.413) },
  ]),
  [WeaponIds.AlleyHunter]: Class.init([
    ...
    STATS.ATK_PERCENTAGE,
    { min_value: formatPercent(0.060), max_value: formatPercent(0.276) },
  ]),
  [WeaponIds.AmenomaKageuchi]: Class.init([
    ...
    STATS.ATK_PERCENTAGE,
    { min_value: formatPercent(0.120), max_value: formatPercent(0.551) },
  ]),
  [WeaponIds.AmosBow]: Class.init([
    ...
    STATS.ATK_PERCENTAGE,
    { min_value: formatPercent(0.108), max_value: formatPercent(0.496) },
  ]),
  [WeaponIds.AquaSimulacra]: Class.init([
    ...
    { min_value: 44, max_value: 542 },
    STATS.CRIT_DMG,
    { min_value: formatPercent(0.192), max_value: formatPercent(0.882) },
  ]),
  ...
  [WeaponIds.AstralVulturesCrimsonPlumage]: Class.init([
    ...
    { min_value: 46, max_value: 608 },
    STATS.CRIT_DMG,
    { min_value: formatPercent(0.144), max_value: formatPercent(0.662) },
  ]),
  [WeaponIds.Azurelight]: Class.init([
    ...
    { min_value: 48, max_value: 674 },
    STATS.CRIT_RATE,
    { min_value: formatPercent(0.048), max_value: formatPercent(0.221) },
  ]),
  [WeaponIds.BalladOfTheBoundlessBlue]: Class.init([
    ...
    { min_value: formatPercent(0.067), max_value: formatPercent(0.306) },
  ]),
  ...
  [WeaponIds.BeaconOfTheReedSea]: Class.init([
    ...
    { min_value: 46, max_value: 608 },
    STATS.CRIT_RATE,
    { min_value: formatPercent(0.072), max_value: formatPercent(0.331) },
  ]),
  [WeaponIds.BlackTassel]: Class.init([
    ...
    STATS.HP_PERCENTAGE,
    { min_value: formatPercent(0.102), max_value: formatPercent(0.469) },
  ]),
  ...
  [WeaponIds.BlackcliffLongsword]: Class.init([
    ...
    { min_value: 44, max_value: 565 },
    STATS.CRIT_DMG,
    { min_value: formatPercent(0.080), max_value: formatPercent(0.368) },
  ]),
  ...
  [WeaponIds.CalamityQueller]: Class.init([
    ...
    { min_value: 49, max_value: 741 },
    STATS.ATK_PERCENTAGE,
    { min_value: formatPercent(0.036), max_value: formatPercent(0.165) },
    ClassPassiveAbility.init([
      "Завет погибели",
  ...
  [WeaponIds.CinnabarSpindle]: Class.init([
    ...
    { min_value: formatPercent(0.150), max_value: formatPercent(0.690) },
    ClassPassiveAbility.init([
      "Добродетель",
  ...
  [WeaponIds.CoolSteel]: Class.init([
    ...
    STATS.ATK_PERCENTAGE,
    { min_value: formatPercent(0.077), max_value: formatPercent(0.352) },
  ]),
  ...
  [WeaponIds.CrescentPike]: Class.init([
    ...
    { min_value: 44, max_value: 565 },
    STATS.PHYSICAL_DMG_BONUS,
    { min_value: formatPercent(0.075), max_value: formatPercent(0.345) },
  ]),
  ...
  [WeaponIds.EndOfTheLine]: Class.init([
    ...
    { min_value: 42, max_value: 510 },
    STATS.ENERGY_RECHARGE,
    { min_value: formatPercent(0.100), max_value: formatPercent(0.459) },
  ]),
  ...
  [WeaponIds.FavoniusGreatsword]: Class.init([
    ...
    { min_value: 41, max_value: 454 },
    STATS.ENERGY_RECHARGE,
    { min_value: formatPercent(0.133), max_value: formatPercent(0.613) },
    ClassPassiveAbility.init([
      "Дружественный бриз",
  ...
  [WeaponIds.FootprintOfTheRainbow]: Class.init([
    ...
    { min_value: 42, max_value: 510 },
    STATS.DEF_PERCENTAGE,
    { min_value: formatPercent(0.113), max_value: formatPercent(0.517) },
  ]),
  ...
  [WeaponIds.Halberd]: Class.init([
    ...
    { min_value: 40, max_value: 448 },
    STATS.ATK_PERCENTAGE,
    { min_value: formatPercent(0.051), max_value: formatPercent(0.235) },
  ]),
  ...
  [WeaponIds.Messenger]: Class.init([
    ...
    { min_value: 40, max_value: 448 },
    STATS.CRIT_DMG,
    { min_value: formatPercent(0.068), max_value: formatPercent(0.312) },
  ]),
  ...
  [WeaponIds.OtherworldlyStory]: Class.init([
    ...
    { min_value: 39, max_value: 401 },
    STATS.ENERGY_RECHARGE,
    { min_value: formatPercent(0.085), max_value: formatPercent(0.390) },
  ]),
  [WeaponIds.PeakPatrolSong]: Class.init([
    ...
    { min_value: 44, max_value: 542 },
    STATS.DEF_PERCENTAGE,
    { min_value: formatPercent(0.180), max_value: formatPercent(0.827) },
  ]),
  ...
  [WeaponIds.SacrificersStaff]: Class.init([
    ...
    STATS.CRIT_RATE,
    { min_value: formatPercent(0.020), max_value: formatPercent(0.092) },
    ClassPassiveAbility.init([
  ...
  [WeaponIds.ScionOfTheBlazingSun]: Class.init([
    ...
    { min_value: 44, max_value: 565 },
    STATS.CRIT_RATE,
    { min_value: formatPercent(0.040), max_value: formatPercent(0.184) },
  ]),
  ...
  [WeaponIds.SkyriderGreatsword]: Class.init([
    ...
    { min_value: 39, max_value: 401 },
    STATS.PHYSICAL_DMG_BONUS,
    { min_value: formatPercent(0.096), max_value: formatPercent(0.439) },
  ]),
  [WeaponIds.SkyriderSword]: Class.init([
    ...
    { min_value: 38, max_value: 354 },
    STATS.ENERGY_RECHARGE,
    { min_value: formatPercent(0.113), max_value: formatPercent(0.521) },
  ]),
  ...
  [WeaponIds.SongOfBrokenPines]: Class.init([
    ...
    { min_value: 49, max_value: 741 },
    STATS.PHYSICAL_DMG_BONUS,
    { min_value: formatPercent(0.045), max_value: formatPercent(0.207) },
  ]),
  ...
  [WeaponIds.TravelersHandySword]: Class.init([
    ...
    { min_value: 40, max_value: 448 },
    STATS.DEF_PERCENTAGE,
    { min_value: formatPercent(0.064), max_value: formatPercent(0.293) },
  ]),
  ...
  [WeaponIds.TwinNephrite]: Class.init([
    ...
    { min_value: 40, max_value: 448 },
    STATS.CRIT_RATE,
    { min_value: formatPercent(0.034), max_value: formatPercent(0.156) },
  ]),
  ...
  [WeaponIds.WavebreakersFin]: Class.init([
    ...
    { min_value: 45, max_value: 620 },
    STATS.ATK_PERCENTAGE,
    { min_value: formatPercent(0.030), max_value: formatPercent(0.138) },
    ClassPassiveAbility.init([
  ...
  [WeaponIds.WhiteTassel]: Class.init([
    ...
    { min_value: 39, max_value: 401 },
    STATS.CRIT_RATE,
    { min_value: formatPercent(0.051), max_value: formatPercent(0.234) },
    ClassPassiveAbility.init([
      "Зоркий",
