...
export default new CharacterRecommendations(CharacterIds.Jean)
  ...
  .setWeapons([
    new CharacterWeaponRecommendation(WeaponIds.FavoniusSword).setIsBetter("Лучшее сигнатурное/доступное оружие").setRefinement(5),
  ]);
