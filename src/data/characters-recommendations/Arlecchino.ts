...
export default new CharacterRecommendations(CharacterIds.Arlecchino)
  ...
  .setWeapons({
    [`Гиперкери | Прожарка | ${elementalReactionLink(ElementalReactionIds.Overloaded, "Перегрузка")}`]: [
      new CharacterWeaponRecommendation(WeaponIds.CrimsonMoonsSemblance).setIsBetter("Лучшее оружие").setPercent(1.316),
      ...
      new CharacterWeaponRecommendation(WeaponIds.Deathmatch).setPercent(1.087).setPostfix("1 враг").setRefinement(5),
      ...
      new CharacterWeaponRecommendation(WeaponIds.Deathmatch).setPercent(1.032).setPostfix("1 враг").setRefinement(1),
    ...
    [`${elementalReactionLink(ElementalReactionIds.Vaporize, "Пар")} | ${elementalReactionLink(ElementalReactionIds.Melt, "Таяние")}`]: [
      new CharacterWeaponRecommendation(WeaponIds.CrimsonMoonsSemblance).setIsBetter("Лучшее оружие").setPercent(1.309),
      ...
      new CharacterWeaponRecommendation(WeaponIds.Deathmatch).setPercent(1.105).setPostfix("1 враг").setRefinement(5),
      new CharacterWeaponRecommendation(WeaponIds.LumidouceElegy).setPercent(1.103),
      ...
      new CharacterWeaponRecommendation(WeaponIds.Deathmatch).setPercent(1.043).setPostfix("1 враг").setRefinement(1),
