...
export default new CharacterRecommendations(CharacterIds.Furina)
  ...
  .setWeapons({
    "Без реакций - 120% ВЭ+": [
      ...
      new CharacterWeaponRecommendation(WeaponIds.FesteringDesire).setIsBetter("Лучшее эпическое оружие").setPercent(1.0924),
    ...
    "Без реакций - 170% ВЭ+": [
      ...
      new CharacterWeaponRecommendation(WeaponIds.FesteringDesire).setIsBetter("Лучшее эпическое оружие").setPercent(0.9878),
    ...
    "Без реакций - 220% ВЭ+": [
      ...
      new CharacterWeaponRecommendation(WeaponIds.FesteringDesire).setIsBetter("Лучшее эпическое оружие").setPercent(0.9498),
    ...
    "Фурина вейпит - 180% ВЭ+": [
      ...
      new CharacterWeaponRecommendation(WeaponIds.FesteringDesire).setIsBetter("Лучшее эпическое оружие").setPercent(1.0906),
