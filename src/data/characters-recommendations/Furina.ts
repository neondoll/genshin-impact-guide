...
export default new CharacterRecommendations(CharacterIds.Furina)
  ...
  .setWeapons({
    "Без реакций - 120% ВЭ+": [
      new CharacterWeaponRecommendation(WeaponIds.SplendorOfTranquilWaters).setIsBetter("Лучшее оружие (низкая зависимость)").setPercent(1.3648),
      ...
      new CharacterWeaponRecommendation(WeaponIds.FesteringDesire).setIsBetter("Лучшее эвентовое оружие").setPercent(1.0924),
      new CharacterWeaponRecommendation(WeaponIds.WolfFang).setPercent(1.0648).setRefinement(1),
      new CharacterWeaponRecommendation(WeaponIds.FleuveCendreFerryman).setIsBetter("Лучшее доступное оружие").setPercent(1.0000).setRefinement(5),
    ...
    "Без реакций - 170% ВЭ+": [
      new CharacterWeaponRecommendation(WeaponIds.SplendorOfTranquilWaters).setIsBetter("Лучшее оружие (низкая зависимость)").setPercent(1.1296),
      ...
      new CharacterWeaponRecommendation(WeaponIds.FesteringDesire).setIsBetter("Лучшее эвентовое оружие").setPercent(0.9878),
    ...
    "Без реакций - 220% ВЭ+": [
      new CharacterWeaponRecommendation(WeaponIds.SplendorOfTranquilWaters).setIsBetter("Лучшее оружие (низкая зависимость)").setPercent(1.0893),
      ...
      new CharacterWeaponRecommendation(WeaponIds.FesteringDesire).setIsBetter("Лучшее эвентовое оружие").setPercent(0.9498),
    ...
    "Фурина вейпит - 180% ВЭ+": [
      new CharacterWeaponRecommendation(WeaponIds.SplendorOfTranquilWaters).setIsBetter("Лучшее оружие (низкая зависимость)").setPercent(1.2547),
      ...
      new CharacterWeaponRecommendation(WeaponIds.FesteringDesire).setIsBetter("Лучшее эвентовое оружие").setPercent(1.0906),
