...
export default new CharacterRecommendations(CharacterIds.KujouSara)
  ...
  .setWeapons([
    ...
    new CharacterWeaponRecommendation(WeaponIds.FadingTwilight).setIsBetter("Лучшее доступное оружие").setRefinement(5),
  ]);
