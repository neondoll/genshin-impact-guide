...
const ResourceFoodUtility = {
  ...
  DecreasesAllPartyMembersSprintingAndSwimmingStaminaConsumptionFor900s: (stamina: number | string) => `Уменьшает потребление выносливости всеми членами отряда во время спринта и плаванья на <span class="text-cyan-500">${stamina}%</span> на 900 сек. В совместном режиме этот эффект применяется только к вашим персонажам.`,
  DecreasesAllPartyMembersSprintingStaminaConsumptionFor900s: (stamina: number | string) => `Уменьшает потребление выносливости всеми членами отряда во время спринта на <span class="text-cyan-500">${stamina}%</span> в течение 900 сек. В совместном режиме этот эффект применяется только к вашему персонажу.`,
  DecreasesAllPartyMembersSprintingStaminaConsumptionFor1500s: (stamina: number | string) => `Уменьшает потребление выносливости всеми членами отряда во время спринта на <span class="text-cyan-500">${stamina}%</span> в течение 1500 сек. В совместном режиме этот эффект применяется только к вашему персонажу.`,
...
const LotusSeedAndBirdEggSoup = {
  [ResourceFoodIds.CloudShroudedJade]: ResourceFoodClass.init([
  ...
  [ResourceFoodIds.DeliciousLotusSeedAndBirdEggSoup]: ResourceFoodClass.init([
  ...
  [ResourceFoodIds.LotusSeedAndBirdEggSoup]: ResourceFoodClass.init([
  ...
  [ResourceFoodIds.SuspiciousLotusSeedAndBirdEggSoup]: ResourceFoodClass.init([
  ...
  [ResourceRecipeIds.RecipeLotusSeedAndBirdEggSoup]: ResourceRecipeClass.init([
    ...
    [
      new ResourceRecipeIngredientClass(ResourceCookingIngredientIds.BirdEgg, 1),
      new ResourceRecipeIngredientClass(ResourceCookingIngredientIds.LotusHead, 1),
      new ResourceRecipeIngredientClass(ResourceCookingIngredientIds.Sugar, 1),
    ],
  ]),
};
...
export default {
  ...
  /* Кухонные ингредиенты            */ ...{
    ...
    [ResourceCookingIngredientIds.LotusHead]: ResourceCookingIngredientClass.init([
