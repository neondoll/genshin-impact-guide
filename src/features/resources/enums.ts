export const ResourceCookingIngredientIds = {
  ...
  /* Красный грибофрукт */ RedBerryshroom: "red_berryshroom",
  /* Рис                */ Rice: "rice",
  /* Соль               */ Salt: "salt",
...
export const ResourceFoodIds = {
  ...
  /* Вкусный «Яркий лес» */
  DeliciousForestOfColor: "delicious_forest_of_color",
  ...
  DeliciousPetitGateauDebordRevisedVersion: "delicious_petit_gateau_debord_revised_version",
  /* Вкусная «Расти гора» */
  ...
  /* «Позолоченный зал» */
  GildedHall: "gilded_hall",
  /* Эталонное здоровое блюдо */
  GoldStandardHealthyMeal: "gold_standard_healthy_meal",
  ...
  /* Тортик «Дебор»: Особый */
  PetitGateauDebordRevisedVersion: "petit_gateau_debord_revised_version",
  /* «Расти гора» */
  PileEmUp: "pile_em_up",
  ...
  /* Странный «Яркий лес» */
  SuspiciousForestOfColor: "suspicious_forest_of_color",
  ...
  SuspiciousPetitGateauDebordRevisedVersion: "suspicious_petit_gateau_debord_revised_version",
  /* Странная «Расти гора» */
  ...
  Warmth: "warmth",
  /* Прибрежные пески */
  WaveKissedSands: "wave_kissed_sands",
  /* «Лесной сон» */
...
export const ResourceRecipeIds = {
  ...
  /* Рецепт: Напиток 455 */
  RecipeDrink455: "recipe_drink_455",
  /* Рецепт: «Яркий лес» */
  RecipeForestOfColor: "recipe_forest_of_color",
  /* Рецепт: «Лёгкий морской бриз» */
  RecipeGentleSeaBreeze: "recipe_gentle_sea_breeze",
  ...
  RecipeMeatLoversFeast: "recipe_meat_lovers_feast",
  ...
  RecipeNineFruitNectar: "recipe_nine_fruit_nectar",
  /* Рецепт: Тортик «Дебор»: Особый */
  RecipePetitGateauDebordRevisedVersion: "recipe_petit_gateau_debord_revised_version",
  /* Рецепт: «Расти гора» */
  RecipePileEmUp: "recipe_pile_em_up",
