...
export const CharacterRecommendationsVideoSources = {
  ...
  FirstConstellationOrSignatureWeapon: new VideoSourceClass("Miron MinMax: С1 или Сигна? Что Лучше и Насколько? | Про Всех 5★ Персонажей").setYoutubeUrl("https://youtu.be/NfgsESKwsdk"),
} as const;
