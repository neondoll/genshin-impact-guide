...
export default new CharacterRecommendationsClass(CharacterIds.Jean)
  .setTalentLeveling([
  ...
  .setWeapons([new CharacterWeaponRecommendationClass(WeaponKeys.FavoniusSword).setIsBetter().setRefinement(5)]);
