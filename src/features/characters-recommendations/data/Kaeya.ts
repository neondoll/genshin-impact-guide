...
export default new CharacterRecommendationsClass(CharacterIds.Kaeya)
  .setTalentLeveling([
  ...
  .setWeapons([new CharacterWeaponRecommendationClass(WeaponKeys.MistsplitterReforged).setIsBetter().setRefinement(1)]);
