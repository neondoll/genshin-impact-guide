...
export default {
  artifacts: {
    ...
    stats: {
      ...
      [ArtifactSlotIds.Goblet]: [{ key: StatKeys.PyroDmgBonus, notes: ["Всегда"] }],
  ...
  character_key: CharacterIds.Mavuika,
  ...
  squads: {
    ...
    best_teammates: {
      [`В целом (${gameVariants[GameVariantEnum.Dps]})`]: [
        { type: "character", key: CharacterIds.Xilonen },
        { type: "character", key: CharacterIds.Bennett },
        { type: "character", key: CharacterIds.Iansan },
      ],
      [`В мелте (${gameVariants[GameVariantEnum.Dps]})`]: [
        { type: "character", key: CharacterIds.Citlali },
        { type: "character", key: CharacterIds.Escoffier },
        { type: "character", key: CharacterIds.Rosaria },
      ],
      [`В вейпе (${gameVariants[GameVariantEnum.Dps]})`]: [
        { type: "character", key: CharacterIds.Furina },
        { type: "character", key: CharacterIds.Yelan },
      ],
      [`В перегрузе (${gameVariants[GameVariantEnum.Dps]})`]: [
        { type: "character", key: CharacterIds.Chevreuse },
        { type: "character", key: CharacterIds.Ororon },
      ],
    },
  },
  talent_leveling: [
