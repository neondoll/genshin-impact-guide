...
export default new CharacterRecommendationsClass(CharacterIds.KujouSara)
  .setTalentLeveling([
  ...
  .setWeapons([new CharacterWeaponRecommendationClass(WeaponKeys.ElegyForTheEnd).setIsBetter().setRefinement(1)]);
