...
export default new CharacterRecommendationsClass(CharacterIds.Baizhu)
  ...
  .setWeapons([
    new CharacterWeaponRecommendationClass(WeaponIds.HakushinRing).setRefinement(5),
    new CharacterWeaponRecommendationClass(WeaponIds.FavoniusCodex).setIsBetter().setRefinement(5),
    new CharacterWeaponRecommendationClass(WeaponIds.JadefallsSplendor).setRefinement(1),
  ]);
