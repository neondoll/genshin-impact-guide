...
export default new CharacterRecommendationsClass(CharacterIds.Diona)
  .setTalentLeveling([
  ...
  .setWeapons([
    new CharacterWeaponRecommendationClass(WeaponKeys.SacrificialBow).setIsBetter().setRefinement(5),
