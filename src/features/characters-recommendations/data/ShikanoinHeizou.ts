...
export default new CharacterRecommendationsClass(CharacterIds.ShikanoinHeizou)
  ...
  .setWeapons([
    ...
    new CharacterWeaponRecommendationClass(WeaponKeys.HakushinRing).setIsBetter().setRefinement(5),
    new CharacterWeaponRecommendationClass(WeaponKeys.FavoniusCodex).setIsBetter().setRefinement(5),
    new CharacterWeaponRecommendationClass(WeaponKeys.PrototypeAmber).setIsBetter().setRefinement(5),
  ]);
