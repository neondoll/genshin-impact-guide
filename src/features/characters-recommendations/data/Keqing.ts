...
export default new CharacterRecommendationsClass(CharacterIds.Keqing)
  .setTalentLeveling([
  ...
  .setWeapons([
    ...
    new CharacterWeaponRecommendationClass(WeaponKeys.LightOfFoliarIncision).setRefinement(1),
  ]);
