...
export default new CharacterRecommendationsClass(CharacterIds.Gorou)
  .setTalentLeveling([
  ...
  .setWeapons([new CharacterWeaponRecommendationClass(WeaponKeys.FavoniusWarbow).setIsBetter().setRefinement(5)]);
