...
export default new CharacterRecommendationsClass(CharacterIds.Tartaglia)
  ...
  .setWeapons([
    new CharacterWeaponRecommendationClass(WeaponKeys.PolarStar).setIsBetter().setRefinement(1),
