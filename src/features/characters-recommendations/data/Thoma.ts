...
export default new CharacterRecommendationsClass(CharacterIds.Thoma)
  .setTalentLeveling([
  ...
  .setWeapons([new CharacterWeaponRecommendationClass(WeaponKeys.KitainCrossSpear).setIsBetter().setRefinement(5)]);
