...
export default new CharacterRecommendationsClass(CharacterIds.Chongyun)
  .setTalentLeveling([
  ...
  .setWeapons([
    new CharacterWeaponRecommendationClass(WeaponKeys.SacrificialGreatsword).setIsBetter().setRefinement(5),
  ]);
