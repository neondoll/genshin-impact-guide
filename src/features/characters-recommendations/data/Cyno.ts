...
export default new CharacterRecommendationsClass(CharacterIds.Cyno)
  ...
  .setWeapons([
    new CharacterWeaponRecommendationClass(WeaponKeys.StaffOfTheScarletSands).setIsBetter().setRefinement(1),
    new CharacterWeaponRecommendationClass(WeaponKeys.WhiteTassel).setRefinement(5),
  ]);
