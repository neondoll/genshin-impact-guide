...
export default new CharacterRecommendationsClass(CharacterIds.KamisatoAyato)
  ...
  .setWeapons([
    new CharacterWeaponRecommendationClass(WeaponKeys.HaranGeppakuFutsu).setIsBetter().setRefinement(1),
