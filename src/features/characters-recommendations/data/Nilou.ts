...
export default new CharacterRecommendationsClass(CharacterIds.Nilou)
  ...
  .setWeapons([
    new CharacterWeaponRecommendationClass(WeaponIds.KeyOfKhajNisut).setIsBetter().setRefinement(1),
    new CharacterWeaponRecommendationClass(WeaponIds.IronSting).setRefinement(5),
  ]);
