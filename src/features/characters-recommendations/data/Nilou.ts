...
export default new CharacterRecommendationsClass(CharacterIds.Nilou)
  ...
  .setWeapons([
    new CharacterWeaponRecommendationClass(WeaponKeys.KeyOfKhajNisut).setIsBetter().setRefinement(1),
    new CharacterWeaponRecommendationClass(WeaponKeys.IronSting).setRefinement(5),
  ]);
