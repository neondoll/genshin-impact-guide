...
export default new CharacterRecommendationsClass(CharacterIds.Lynette)
  .setTalentLeveling([
  ...
  .setWeapons([
    ...
    new CharacterWeaponRecommendationClass(WeaponKeys.SacrificialSword).setRefinement(5),
  ]);
