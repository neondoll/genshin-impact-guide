...
export default new CharacterRecommendationsClass(CharacterIds.Razor)
  ...
  .setWeapons([
    new CharacterWeaponRecommendationClass(WeaponKeys.BloodtaintedGreatsword).setIsBetter().setRefinement(5),
    new CharacterWeaponRecommendationClass(WeaponKeys.Rainslasher).setRefinement(5),
    new CharacterWeaponRecommendationClass(WeaponKeys.MakhairaAquamarine).setRefinement(5),
  ]);
