...
export default new CharacterRecommendationsClass(CharacterIds.Charlotte)
  .setTalentLeveling([
  ...
  .setWeapons([
    new CharacterWeaponRecommendationClass(WeaponKeys.ThrillingTalesOfDragonSlayers).setRefinement(5),
