...
export default {
  [ElementKeys.Anemo]: { ...recommendations, character_key: CharacterIds.TravelerAnemo },
  [ElementKeys.Dendro]: { ...recommendations, character_key: CharacterIds.TravelerDendro },
  [ElementKeys.Electro]: { ...recommendations, character_key: CharacterIds.TravelerElectro },
  [ElementKeys.Geo]: { ...recommendations, character_key: CharacterIds.TravelerGeo },
  [ElementKeys.Hydro]: { ...recommendations, character_key: CharacterIds.TravelerHydro },
  [ElementKeys.Pyro]: {
    artifacts: {
      sets: [
      ...
      stats: {
        [ArtifactSlotIds.Sands]: [{ key: StatKeys.AtkPercentage }],
        [ArtifactSlotIds.Goblet]: [{ key: StatKeys.PyroDmgBonus }, { key: StatKeys.AtkPercentage }],
        [ArtifactSlotIds.Circlet]: [{ key: StatKeys.CritRate }, { key: StatKeys.CritDMG }],
        additional: [
    ...
    character_key: CharacterIds.TravelerPyro,
    video_sources: [
      {
...
} as Record<Exclude<TElementKey, typeof ElementKeys.Cryo>, CharacterRecommendations>;
